...
const VideoSection = () => {
  ...
  // Get video URL from settings, fallback to default mp4
  const rawVideoUrl = get('video_url') || '/project-tour.mp4';
  const youtubeEmbedUrl = isYouTubeUrl(rawVideoUrl) ? getYouTubeEmbedUrl(rawVideoUrl) : null;
        ...
        >
          {youtubeEmbedUrl ? (
            ...
            <iframe
              ...
              src={youtubeEmbedUrl}
              title="جولة مرئية - The View Avenue"
              frameBorder="0"
