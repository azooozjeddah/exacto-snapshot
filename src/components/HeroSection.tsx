...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Fixed solid black header bar */}
      <div className="absolute top-0 left-0 right-0 z-30 h-[100px] bg-black">
      ...
      {/* Hero background - shifted down so header covers the baked-in logo */}
      <img
        src={heroBg}
        alt="The View Avenue"
