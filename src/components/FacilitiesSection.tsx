...
const facilities = [
  {
    src: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663383033257/mklqtCWrielPznkj.webp",
    title: "الواجهة الرئيسية",
    subtitle: "Main Facade",
  },
  {
    src: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663383033257/dAknYcCQLpneEHrU.webp",
    title: "المنظر الجوي",
    subtitle: "Aerial View",
  },
  {
    src: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663383033257/FhsyvhjJeuTChZtW.webp",
    title: "الساحة والنوافير",
    subtitle: "Fountain Square",
  },
  {
    src: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663383033257/ZyFBSigFcnCrXiLZ.webp",
    title: "البلازا المفتوحة",
    subtitle: "Open Plaza",
  },
  {
    src: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663383033257/pgEdBwTDFJeSUNug.webp",
    title: "الممشى المائي",
    subtitle: "Water Walkway",
  },
];
    ...
    <>
      ...
      {lightbox !== null && (
        ...
        >
          ...
          <button
            onClick={(e) => { e.stopPropagation(); setLightbox((i) => (i !== null ? (i - 1 + facilities.length) % facilities.length : null)); }}
            className="absolute left-4 text-foreground/70 hover:text-foreground transition-colors"
          >
            <ChevronLeft className="w-10 h-10" />
          </button>
          <button
            onClick={(e) => { e.stopPropagation(); setLightbox((i) => (i !== null ? (i + 1) % facilities.length : null)); }}
          ...
          <div className="text-center">
            <img
              src={facilities[lightbox].src}
              alt={facilities[lightbox].title}
