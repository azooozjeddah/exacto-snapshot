      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            موقع استراتيجي في قلب مدينة جدة
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-lg overflow-hidden border border-border glow-gold">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59536.21!2d39.15!3d21.54!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d01fb1137e59%3A0xe059579737b118db!2sJeddah%20Saudi%20Arabia!5e0!3m2!1sar!2ssa!4v1"
              width="100%"
              height="400"
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  يقع المشروع في موقع حيوي بقلب مدينة جدة، على مقربة من أهم المحاور والطرق الرئيسية
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  على بعد دقائق من مطار الملك عبدالعزيز الدولي
                </p>
              </div>
            </div>
