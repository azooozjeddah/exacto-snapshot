...
const Index = () => {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* WhatsApp Floating Button - Luxury Style */}
      <a
        href="https://wa.me/966555610198"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 left-8 z-50 w-16 h-16 bg-black border-2 border-[#D4AF37] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] hover:scale-110 transition-all duration-300 group overflow-hidden"
        aria-label="تواصل عبر واتساب"
      >
        <div className="absolute inset-0 bg-[#D4AF37] opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
        <svg viewBox="0 0 32 32" className="w-8 h-8 fill-[#D4AF37] relative z-10">
