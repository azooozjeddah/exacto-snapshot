    ...
    <div dir="rtl" className="min-h-screen flex items-center justify-center bg-[#F8F9FA]" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      <div className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">تسجيل دخول المحاسب — Accountant Login</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" value={email} onChange={(e) => { setEmail(e.target.value); setError(''); }}
                placeholder="accountant@example.com" required maxLength={255}
                className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-[#D4AF37] focus:ring-[#D4AF37]/20 h-12" dir="ltr" />
            </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">© 2025 The View Avenue. جميع الحقوق محفوظة</p>
      </div>
    </div>
  );
}
